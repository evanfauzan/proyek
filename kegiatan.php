  ...
  <body style="background-image: url(background.png)">
    ...
    <div class="container mt-5">
      ...
      <div class="row" id="activities">
        ...
        <div class="col-md-12 activity" data-aos="fade-up">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="400">
        ...
        <!-- Kegiatan 6: Rekreasi -->
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="500">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="600">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="700">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="800">
        ...
        <div class="col-md-12 activity" data-aos="fade-up" data-aos-delay="900">
