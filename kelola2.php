...
<html lang="id">
  ...
  <body>
    ...
    <div class="container my-5">
      ...
      <h1 class="text-center text-primary mb-5">Galeri MI</h1>

      <!-- Form Upload Gambar -->
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="card shadow-sm p-4">
            <h3 class="text-center mb-4">Upload Gambar Pondok Pesantren MI</h3>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php
                  require "koneksi.php";
                  $n = 0;
                  $query = "SELECT * FROM db_gambar_mi;";
                ...
                ?>
                  <tr>
                    ...
                    <td><img src="MI/<?php echo $result['foto']; ?>" alt="Gambar" class="img-thumbnail"></td>
                    <td>
                      <a href="proses2.php?hapus=<?php echo $result['id']; ?>" 
