  ...
  <body style="background-image: url(background.png)">
    ...
    <main class="container my-4 bg-light bg-gradient shadow p-3">
      <div class="text-center">
        <h2 class="judul2">Galeri Madrasah Aliyah</h2>
      </div>

      <div class="row">
        <?php
          require "koneksi.php";
          $query = "SELECT * FROM db_gambar_ma ORDER BY id DESC;";
          $sql = mysqli_query($konek, $query);
        ...
        ?>
              <div class="col-md-4 mb-4" data-aos="zoom-in" data-aos-duration="400">
                  <div class="card border-0">
                      <img src="MA/<?php echo $result['foto']; ?>" alt="Kegiatan <?php echo $i; ?>" class="gallery-item img-fluid" onclick="openPopup('MA/<?php echo $result['foto']; ?>')" />
                  </div>
              </div>
        <?php
            }
