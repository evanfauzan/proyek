  ...
  <body style="background-image: url(background1.png)">
    ...
    <main class="container my-4 bg-light bg-gradient shadow p-3">
      <div class="text-center">
        <h2 class="judul2">Galeri Madrasah Ibtidaiyah</h2>
      </div>

      <div class="row">
        <?php
          require "koneksi.php";
          $query = "SELECT * FROM db_gambar_mi ORDER BY id DESC;";
        ...
        ?>
              <div class="col-md-4 mb-4" data-aos="zoom-in" data-aos-duration="400">
                  <div class="card border-0">
                      <img src="MI/<?php echo $result['foto']; ?>" alt="Kegiatan <?php echo $i; ?>" class="gallery-item img-fluid" onclick="openPopup('MI/<?php echo $result['foto']; ?>')" />
                  </div>
              </div>
        <?php
            }
