...
<body style="background-image: url(background1.png); overflow-x: hidden">
    ...
    <div class="container-fluid section bg-light-custom p-4">
        ...
        <p class="text-center">
            Pondok Pesantren Darul Quran, terletak di Desa Sumber Hidup, didirikan pada tahun 1983. Dengan lokasi strategis dan alam subur, tempat ini ideal untuk belajar dan beribadah.
        </p>
        <p class="text-center">
            Sebagai sekolah Islam berlandaskan Nahdlatul Ulama (NU), santri memiliki pilihan untuk mondok atau pulang pergi. Fokus pada pengajaran akademis dan pembentukan karakter.
        </p>
        <p class="text-center">
            Program-program kami mengajarkan santri untuk menghargai nilai tradisional dan modern, serta berkontribusi positif kepada masyarakat.
        </p>
    </div>
